...
?>
        <div id="multiple-selectors-modal" uk-modal>
            <div class="uk-modal-dialog uk-modal-body">
                ...
                <p>In the free version of the plugin you can add 1 selector. If you want to add more selectors you can get the premium version.<br><a href="https://velocityplugins.com/" class="velo-unlock-premium-button" target="_blank">Get premium plugin <span class="uk-icon-link" uk-icon="star"></span></a></p>
